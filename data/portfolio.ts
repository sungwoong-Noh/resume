...
export const portfolioProjects: PortfolioProject[] = [
  ...
  },
  {
    ...
    detailParagraphs: [
      '공공 예산심사 시스템이라 자산 데이터의 정확성·변경 이력 추적과 대규모 처리 성능이 모두 걸려 있었습니다. 5인 팀에서 핵심인 자산 동기화 성능(2시간 → 10초)을 잡는 동시에, **예산심사의 감사·심사 규정을 도메인 모델과 검증 구조로 정확히 옮기는 데** 집중했습니다.',
      '특히 감사 요구(변경 이력 추적)와 사업유형별로 다른 심사 규정을 코드 구조로 반영한 부분이 이 프로젝트의 핵심 설계입니다. 단순 이력 적재가 아니라 **7종 자원을 필드 단위로 비교해 실제 변경만 적재**하고, **Bean Validation Group으로 사업유형별 검증 규칙을 런타임 분기**해 심사자와 실무자 양쪽이 신뢰할 수 있게 만들었습니다. (상세는 아래 Key Responsibilities 참고)',
    ],
    keyResponsibilities: [
      {
