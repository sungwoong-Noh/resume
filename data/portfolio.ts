...
export const portfolioProjects: PortfolioProject[] = [
  {
    ...
    keyResponsibilities: [
      ...
      {
        result: '다단계 벤더 프로비저닝을 **Saga 패턴(11개 예외 타입 기반 차등 롤백)**으로 설계 · 실패 지점 무관 자원 고아 상태 구조적 방지, 벤더 추가 시 예외 타입·핸들러만 추가하는 확장 구조',
