...
export const profile = {
  ...
  yearsOfExp: 5,
  tagline: '문제를 스스로 발굴해 근본 원인을 해결하고, AI 활용·개발 표준화로 팀 생산성을 높여온 백엔드 개발자',
   ...
   */
  intro: `JPA 내부 동작을 이해하고 실행계획을 분석해 쿼리 구조를 재설계했습니다. 130만 건 DB 조회 p95를 17초에서 3초로, 동기화 배치를 2시간에서 10초로 단축한 것처럼 근본 원인부터 해결합니다.
QueryDSL 도입, JUnit5 테스트 문화 정착, Jenkins CI/CD 구축, Claude MCP 활용 운영 자동화까지 더 나은 개발 환경을 위한 변화를 직접 제안하고 실행해왔습니다.
AWS ECS 기반 MSA 설계부터 배치·알림·API 개발까지, 서비스 전반을 주도적으로 맡아온 백엔드 개발자입니다.`,
}
