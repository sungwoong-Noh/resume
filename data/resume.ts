        ...
        resumeContent: [
          ...
          },
          {
            ...
            body: [
              ...
              '이를 바탕으로 단계별로 롤백 범위가 다른 **11개의 계층형 예외 타입**을 설계하고, **보상 트랜잭션 기반의 오케스트레이션(Saga 패턴)**을 구현했습니다. 공통 예외는 상속으로 재사용하고, 하위 예외마다 롤백에 필요한 컨텍스트만 얹었습니다. 이 뼈대 위에서 **각 도메인 담당자는 자기 단계의 롤백만 정의하면 되도록** 만들어, 공통 구조와 도메인 지식을 분리했습니다.',
            ],
            result: [
