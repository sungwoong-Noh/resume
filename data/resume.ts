      ...
      },
      {
        ...
        resumeContent: [
          ...
          },
          {
            ...
            body: [
              '고객이 자원을 신청하면 운영자가 직접 내부 시스템에서 자원을 생성해주는 **매니지드 방식**이었고, **반복 처리 요청이 체감상 월 50건 안팎**으로 상당한 비중을 차지했으며, 고객이 직접 자원을 제어할 수 없는 **반쪽짜리 CSP** 구조였습니다.',
          ...
          },
          {
            ...
            body: [
              ...
              '선임 개발자와 함께 **코딩 컨벤션·공통 모듈·에러 처리 표준을 수립**하고, **JUnit5 기반 테스트를 핵심 기능부터 점진적으로 도입**해 수동 검증 문화를 바꿨습니다. 장비 API를 실제 호출해 검증하는 통합 테스트로 스펙 불일치·IP 충돌을 사전에 잡았습니다.',
            ],
