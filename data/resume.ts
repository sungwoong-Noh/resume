        ...
        resumeContent: [
          {
            ...
            body: [
              '백엔드 5인 팀 중 **로드밸런서(L4)·포트포워딩 상품**은 혼자 담당해 개발했습니다. 당시 고객은 자기 자원을 직접 만들 수 없고, 신청하면 운영자가 대신 생성해주는 **매니지드 방식**이었습니다. 방화벽 정책 하나, 포트포워딩 하나를 바꾸려 해도 요청을 넣고 담당자가 처리해줄 때까지 기다려야 했고, 이런 반복 요청이 **체감상 월 50건 안팎**으로 운영자 손이 계속 묶였습니다. 고객 입장에선 자기 자원을 직접 제어할 수 없는 **반쪽짜리 CSP**였습니다.',
