        ...
        resumeContent: [
          {
            ...
            body: [
              ...
              'CSP 인프라 특성상 **장비 자체는 이미 멀티테넌트 기능을 갖추고 있었지만**, 이를 고객에게 안전하게 직접 열어주려면 여러 벤더 장비를 안정적으로 오케스트레이션하는 문제를 먼저 해결해야 했습니다. 그래서 이 기능을 운영자 개입 없이 고객에게 직접 안전하게 노출하는 API 서버를 신규 개발했습니다. 고객이 자기 테넌트 범위 안에서 직접 자원을 신청하면 즉시 처리되도록 흐름을 바꿨습니다.',
