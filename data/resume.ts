        ...
        resumeContent: [
          {
            ...
            body: [
              'MSP로 관리하는 **40개 이상 고객사의 클라우드 인프라 통합 관제 체계**를 직접 제안하고 구축한 프로젝트입니다. 기존 KT Cloud Watch는 기본 자원 지표를 **7일만 보존**해 일주일 이상 지난 장애의 원인 추적이 불가능했고, **40개 고객사를 한눈에 보는 통합 관제도 없었습니다**. 문제가 생기면 수십 개 서버를 일일이 접속해 로그를 뒤져야 했고, 월간 보고서도 서버마다 직접 접속해 리소스를 확인하는 방식이라 **서버 20개 기준 2시간 이상** 걸렸습니다.',
        ...
        achievements: [
          {
            ...
            result: '**코딩 컨벤션·공통 모듈·에러 처리 표준을 직접 정의**해 팀 전체에 적용',
          },
          {
