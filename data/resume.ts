      ...
      },
      {
        ...
        resumeContent: [
          ...
          },
          {
            ...
            body: [
              '고객이 자원을 신청하면 운영자가 직접 내부 시스템에서 자원을 생성해야 하는 티켓 방식이었고, **반복 처리 요청이 체감상 월 50건 안팎**으로 상당한 비중을 차지했으며, 고객이 직접 자원을 제어할 수 없는 **반쪽짜리 CSP** 구조였습니다.',
        ...
        achievements: [
          ...
          {
            problem: '고객이 자원을 신청하면 운영자가 직접 내부 시스템에서 자원을 생성해야 하는 티켓 방식. **반복 처리 요청이 체감상 월 50건 안팎**으로 상당한 비중을 차지하고, 고객이 직접 자원을 제어할 수 없는 **반쪽짜리 CSP** 구조',
