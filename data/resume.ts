    ...
    projects: [
      {
        ...
        resumeContent: [
          {
            ...
            body: [
              '백엔드 5인 팀 중 저는 **로드밸런서(L4)·포트포워딩 상품**을 전담해 개발했습니다. 당시 고객은 자기 자원을 직접 만들 수 없고, 신청하면 운영자가 대신 생성해주는 **매니지드 방식**이었습니다. 로드밸런서에 VM 하나를 연결하려 해도 요청을 넣고 담당자가 처리해줄 때까지 기다려야 했고, 이런 반복 요청이 **체감상 월 50건 안팎**으로 운영자 손이 계속 묶였습니다. 고객 입장에선 자기 자원을 직접 제어할 수 없는 **제한적인 CSP 구조**였습니다.',
        ...
        achievements: [
          ...
          },
          {
            ...
            result: '**자원 고아 상태 구조적 방지** · 벤더 추가 시 예외 타입·핸들러만 추가하는 확장 구조',
          },
          {
