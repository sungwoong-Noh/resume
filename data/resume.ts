        ...
        resumeContent: [
          ...
          },
          {
            ...
            body: [
              ...
              '벤더 장비 연동을 검증하는 테스트 문화는 없었지만, 연동 기능을 개발할 때마다 이런 문제로 고치고 다시 배포하는 과정이 반복되자 사전 검증이 필요하다고 판단했습니다. **Mock 없이 실제 스테이징 장비(TrusGuard·Citrix·ACI 등)를 직접 호출하는 통합 테스트**로 설계해, 각 테스트가 장비 위에 실제 상태를 만들고 정리하는 것까지 스스로 책임지도록 만들었습니다.',
