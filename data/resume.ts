      ...
      },
      {
        ...
        resumeContent: [
          ...
          },
          {
            ...
            body: [
              '네트워크 환경 하나를 만들려면 방화벽·VS·인터페이스·라우트·ACI·OpenStack 등 **서로 다른 벤더의 API를 순서대로 호출**해야 했는데, 이들은 외부 시스템이라 **DB 트랜잭션은 물론 Spring @Transactional로도 묶을 수 없었습니다**. 중간 단계가 실패하면 이미 만들어진 자원이 그대로 남아, 재시도조차 막히는 상황이 발생했습니다.',
