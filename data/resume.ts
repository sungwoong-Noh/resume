...
export const experiences: Experience[] = [
  {
    ...
    projects: [
      ...
      },
      {
        ...
        serviceOverview: '국가정보자원관리원의 IT 자산을 계획·관리하는 시스템입니다. 수십만 건 규모의 자산을 빠르게 동기화·조회하면서도, 예산심사·감사 대응을 위해 데이터 정확성과 변경 이력 추적까지 보장해야 했습니다.',
        resumeContent: [
          {
          ...
          },
          {
            ...
            result: '감사에 필요한 변경 이력 추적과 사업유형별로 다른 심사 규정을 **도메인 모델·검증 구조에 정확히 반영**해, 심사자·실무자 모두 신뢰할 수 있는 시스템으로 설계',
          },
          {
