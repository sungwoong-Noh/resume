              ...
              <div className="p-6 border-b border-gray-100">
                <div className="flex items-start justify-between gap-3 mb-1">
                  <div className="flex items-center gap-2">
                    ...
                    {p.url && (
                      <a href={p.url} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-blue-600 transition flex-shrink-0" aria-label="GitHub">
                ...
                <p className="text-xs text-blue-600 font-mono mb-3">{p.organization}</p>
