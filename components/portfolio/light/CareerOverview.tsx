      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {portfolioProjects.map((project) => (
            <div
              key={project.id}
              className="rounded-2xl bg-white border border-gray-200 hover:border-teal-400/60 transition-colors overflow-hidden"
            >
              ...
              <div className="p-6">
                ...
                <p className="text-xs font-mono text-teal-600 uppercase tracking-wider mb-2">기여도</p>
