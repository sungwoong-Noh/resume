      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-10 mb-12">
          ...
          <div>
            ...
            <p className="text-lg text-gray-800 font-semibold leading-snug mb-5 border-l-4 border-teal-500 pl-3">
              {tagline}
            </p>
            <p className="text-teal-600 font-bold text-base mb-4">{role}</p>
        ...
        <div>
          ...
          <div className="bg-gray-50 rounded-xl p-6 border-l-4 border-teal-500 space-y-3">
